...
public class HelpBoxAttribute : PropertyAttribute
{
    ...
    public HelpBoxAttribute(string text, HelpBoxEnum type = HelpBoxEnum.Info)
    {
        this.text = text;
...
public class HelpDrawer : PropertyDrawer
{
    ...
    /// <summary>
    /// A wrapper which returns the PropertyDrawer.attribute field as a HelpBoxAttribute.
    /// </summary>
    HelpBoxAttribute helpAttribute { get { return (HelpBoxAttribute)attribute; } }
    ...
    // feel is cleaner than having the conditional directive in the middle of the HelpBoxAttribute constructor.
