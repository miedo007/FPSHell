...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_MapName = serializedObject.FindProperty("m_MapName");
            m_ActionName = serializedObject.FindProperty("m_ActionName");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField(m_BindingLabel.ToString(), EditorStyles.boldLabel);
            EditorGUILayout.EndHorizontal();

            m_MapName.stringValue = EditorGUILayout.TextField("Input Map", m_MapName.stringValue);
            m_ActionName.stringValue = EditorGUILayout.TextField("Input Action", m_ActionName.stringValue);
            ...
            EditorGUILayout.BeginVertical("box");
            EditorGUILayout.BeginHorizontal("Toolbar", GUILayout.Height(30));
            EditorGUILayout.LabelField(m_UILabel.ToString(), EditorStyles.boldLabel);
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginVertical("box");
            EditorGUILayout.BeginHorizontal("Toolbar", GUILayout.Height(30));
            EditorGUILayout.LabelField(m_EventsLabel.ToString(), EditorStyles.boldLabel);
            EditorGUILayout.EndHorizontal();
        ...
        protected void RefreshBindingOptions()
        {
            ...
            var action = tinyInput.asset.FindAction(m_ActionName.stringValue);
        ...
        private SerializedProperty m_MapName;
        private SerializedProperty m_ActionName;
