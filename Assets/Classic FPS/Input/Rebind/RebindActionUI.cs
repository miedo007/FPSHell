...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public void TestDebug(string mess)
        {
            Debug.Log(mess);
        }
        ...
        public bool ResolveActionAndBinding(out InputAction action, out int bindingIndex)
        {
            ...
            action = tinyInput.asset.FindAction(m_ActionName);
            if (action == null)
                return false;
        ...
        public void UpdateBindingDisplay()
        {
            ...
            var action = tinyInput.asset.FindAction(m_ActionName);
            if (action != null)
            {
                var bindingIndex = action.bindings.IndexOf(x => x.id.ToString() == m_BindingId);
                if (bindingIndex != -1) { displayString = action.GetBindingDisplayString(bindingIndex, out deviceLayoutName, out controlPath, displayStringOptions);
                }
            }

            // Set on label (if any).
            if (m_BindingText != null) m_BindingText.text = displayString;
        ...
        protected void OnEnable()
        {
            ...
            RebindSaveLoad SaveLoad = GameObject.FindObjectsOfType<RebindSaveLoad>()[0]; m_RebindOverlay = SaveLoad.RebindPanel; m_RebindText = SaveLoad.RebindText;
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < s_RebindActionUIs.Count; ++i)
            {
                ...
                var referencedAction = component.tinyInput.asset.FindAction(component.m_ActionName);
