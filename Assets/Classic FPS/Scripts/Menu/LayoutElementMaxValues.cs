...
namespace HellishBattle.UI
{
    ...
    [System.Serializable]
    public class LayoutElementMaxValues : LayoutElement
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(LayoutElementMaxValues), true)]
    [CanEditMultipleObjects]
    public class LayoutMaxSizeEditor : LayoutElementEditor
    {
        LayoutElementMaxValues layoutMax;
        ...
        protected override void OnEnable()
        {
            ...
            layoutMax = target as LayoutElementMaxValues;
